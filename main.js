...
// What is `givenName` set to right now?
givenName = givenName;
A: still the string 'Tim'


// 4.
// What is `greeting` set to?
let greeting = "Hello, how are you? " + givenName;
A: a concatenation of a string plus the givenName variable. It outputs:
...
let born = 1984;
let today = 2017;
A: var TimAge = "Tim is " + (today - born) + " years old."
...
let myNumber = 7
let myString = "hello, my name is chris!"
let myBoolean = 10 > 5
